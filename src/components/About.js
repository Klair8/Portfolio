...
const About =()=>{
    ...
    <div className='abt'>
        ...
        analytical skills. Team player with an eye for detail. I have a long history
        of working in the marketing and advertising industry.
        ...
        I'm always ready for new challenges and eager to learn more.</p>
            ...
            <div className='skills'>
                ...
                <li>HTML / CSS </li>
                <li>GIT/Github</li>
                <li>Fluent in French, English and
                    Hebrew</li>
